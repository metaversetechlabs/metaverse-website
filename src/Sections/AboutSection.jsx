    ...
    <div className='w-full  items-center' id='aboutus'>
      ...
      <div className='w-full sm:my-20 justify-center flex flex-col-reverse sm:flex-row'>
        <div className='w-full sm:flex-1 flex justify-center items-center'>
          <img className='w-11/12 h-full' src={About} />
        </div>
        <div className='sm:w-1/2 space-y-4 my-7 sm:my-0 flex flex-col px-10 items-center sm:items-start justify-center'>
          <p className='text-white text-smallResized text-center sm:text-justify'>
            ...
            <br />
            <br />
            Our shareholders play a pivotal role in shaping the future of this
            exciting venture, as we continue to explore innovative avenues in
            metaverse development and connectivity.
          </p>
          <Link to='/contact'>
            <div className='flex justify-center items-center text-white text-resized font-semibold gap-2 w-fit px-4 py-2 bg-gradient-to-r to-gradientFont3 from-gradientFont1 rounded-lg '>
              Get In Touch
              <img src={Connect} className='w-6 sm:w-8' />
            </div>
          </Link>
        </div>
      </div>
